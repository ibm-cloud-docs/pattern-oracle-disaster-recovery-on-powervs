...
The Oracle disaster recovery on IBM Power Virtual Systems Server architecture covers design considerations and architecture decisions for the following aspects and domains (as defined in the [Architecture Framework](/docs/architecture-framework?topic=architecture-framework-intro)):
...
![Oracle resiliency architecture design scope](image/pvs-on-ibm-heat-map.drawio.svg){: caption="Figure 4. Oracle resiliency architecture design scope" caption-side="bottom"}
