...
![Figure IBM Power Virtual Server environment and on-premises overview diagram featuring VPC and PowerVS workspace](image/pvsibm-onprem-Architecture-overview-Oracle-Data-Guard-IBM-and-on-prem.drawio.svg){: caption="Figure 1. IBM Power Virtual Server environment and on-premises overview" caption-side="bottom"}
...
Carefully consider options for synchronous and asynchronous replication when you are designing database replication to meet the client requirements. It is recommended that you discuss latency between environments before you decide on a replication method for Oracle. {: note}
...
Active Data Guard enables you to read while the data is syncing. There is no need to pause they sync process. {: note}
...
-   [Connecting to VPC through Direct link](file:////docs/power-iaas%3ftopic=power-iaas-ordering-direct-link-connect).
-   [Connecting to Customer DC through Mega port](file:////docs/power-iaas%3ftopic=power-iaas-network-architecture-diagrams#network-reference-architecture-onprem).
...
Following the [Architecture Design Framework](file:////docs/architecture-framework%3ftopic=architecture-framework-intro), the Resiliency Patterns cover design considerations for the following aspects and domains:
...
![Oracle Data Guard architecture design scope](image/pvs-on-ibm-heat-map.drawio.svg){: caption="Figure 3. Architecture Design Framework" caption-side="bottom"}

The Architecture Design Framework provides a consistent approach to design cloud solutions by addressing requirements across a set of "aspects" and "domains", which are technology-agnostic architectural areas that need to be considered for any enterprise solution. See [Introduction to the Architecture Design Framework](file:////docs/architecture-framework%3ftopic=architecture-framework-intro) for more details.
...
|---------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------|
| Compute                                                 | [VPC VSIs](https://cloud.ibm.com/vpc-ext/provision/vs){: external}, [IBM Power Virtual Server](file:////docs/power-iaas%3ftopic=power-iaas-getting-started)                                                                                                                                                                                                                                                                                                                                                                                                                                         | Oracle Database, other non-Oracle application that is hosted on cloud Non-Oracle workloads that are run on x86 (VPC) and Oracle workloads runs on PowerVS |
...
|                                                         | [Cloud Object Storage](file:////docs/cloud-object-storage%3ftopic=cloud-object-storage-about-cloud-object-storage)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Backups and Logs (application, operational, and audit logs)                                                                                               |
|                                                         | [Block Storage](file:////docs/vpc%3ftopic=vpc-block-storage-about#vpc-storage-encryption)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Block storage for VPC VSI images on x86 workloads                                                                                                         |
| Networking                                              | [Transit Gateway](file:////docs/transit-gateway%3ftopic=transit-gateway-about)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Connects across VPCs and PowerVS                                                                                                                          |
|                                                         | [VPC Virtual Private Network (VPN)](file:////docs/iaas-vpn%3ftopic=iaas-vpn-getting-started)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | Remote access to manage resources in a private network                                                                                                    |
|                                                         | [Virtual Private Gateway & Virtual Private Endpoint (VPE)](file:////docs/vpc%3ftopic=vpc-about-vpe)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Private network access to Cloud Services, for example Key Protect, Cloud Object Storage, and so on.                                                       |
|                                                         | [VPC Application Load Balancers](file:////docs/vpc%3ftopic=vpc-load-balancers)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Application Load Balancing for web servers, app servers, and database servers                                                                             |
|                                                         | [Public Gateway](file:////docs/vpc%3ftopic=vpc-about-public-gateways)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | For web server access to the internet                                                                                                                     |
|                                                         | [Cloud Internet Services (CIS)](file:////docs/cis%3ftopic=cis-getting-started)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Public Load balancing of web server traffic across zones in the region                                                                                    |
|                                                         | [DNS Services](file:////docs/dns-svcs%3ftopic=dns-svcs-about-dns-services)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | Domain Name System (DNS) for Domain name resolution                                                                                                       |
| Security                                                | [IAM](file:////docs/account%3ftopic=account-cloudaccess)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | IBM Cloud Identity & Access Management                                                                                                                    |
|                                                         | [BYO Bastion Host on VPC VSI with PAM SW](file:////docs/framework-financial-services%3ftopic=framework-financial-services-vpc-architecture-connectivity-bastion-tutorial-teleport)                                                                                                                                                                                                                                                                                                                                                                                                                  | Remote access for administrative functions with Privileged Access Management                                                                              |
|                                                         | [Virtual Private Clouds (VPCs), Subnets, Security Groups, ACLs](file:////docs/vpc%3ftopic=vpc-getting-started) Isolated PowerVS LPARs                                                                                                                                                                                                                                                                                                                                                                                                                                                               | Network Segmentation/Isolation for Power VS by using PVS subnets.                                                                                         |
|                                                         | [Cloud Internet Services (CIS)](file:////docs/cis%3ftopic=cis-getting-started)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Public DDoS protection and Web App Firewall                                                                                                               |
|                                                         | [Key Protect](file:////docs/key-protect) or [HPCS](file:////docs/hs-crypto%3ftopic=hs-crypto-get-started)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | HSM and Key Management Service (KYOK)                                                                                                                     |
...
| Service Management (Observability)                      | [IBM Cloud Monitoring](file:////docs/monitoring%3ftopic=monitoring-about-monitor)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Apps and operational monitoring                                                                                                                           |
|                                                         | [IBM Log Analysis](file:////log-analysis%3ftopic=log-analysis-getting-started)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Apps and operational logs                                                                                                                                 |
|                                                         | [Activity Tracker Event Routing](file:////docs/atracker%3ftopic=atracker-about)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Audit logs                                                                                                                                                |
