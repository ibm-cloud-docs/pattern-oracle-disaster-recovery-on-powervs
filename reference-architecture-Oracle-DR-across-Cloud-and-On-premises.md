...
Following the [Architecture Framework](/docs/architecture-framework?topic=architecture-framework-intro), the Resiliency Patterns cover design considerations for the following aspects and domains:
...
![Oracle Data Guard architecture design scope](image/pvs-on-ibm-heat-map.drawio.svg){: caption="Figure 3. Oracle Data Guard architecture design scope" caption-side="bottom"}
...
|                                    | [IBM Log Analysis](/log-analysis?topic=log-analysis-getting-started)                                                                                                                                                                                                                                                                                                                                                                                                                                          | Apps and operational logs                                                                                                                |
|                                    | [Activity Tracker Event Routing](/docs/atracker?topic=atracker-about)                                                                                                                                                                                                                                                                                                                                                                                                                                              | Audit logs                                                                                                                               |
{: caption="Table 1. Pattern components" caption-side="bottom"}
